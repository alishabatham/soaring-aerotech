...
import {
  ChevronRight, ArrowRight, ShieldCheck, GraduationCap, Wrench, Lightbulb,
  Factory, ArrowDown, Play, MapPin, Zap, Target, Award, Quote, Phone,
} from "lucide-react";
...
const galleryRow2 = [
  ...
  { src: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=480&h=320&fit=crop", label: "Solar Inspection" },
  ...
  { src: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=480&h=320&fit=crop", label: "Tower Inspection" },
];
...
const pillars = [
  {
    icon: <GraduationCap className="w-7 h-7" />, tag: "TRAIN", title: "DGCA Pilot Training",
    ...
    points: ["DGCA Certified RPTO", "8 Specialized Programs", "RPC Certification", "Corporate Batches"],
    img: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=700&h=460&fit=crop",
    link: "/training",
  },
  {
    icon: <Wrench className="w-7 h-7" />, tag: "SERVE", title: "Drone Services",
  ...
  },
  {
    ...
    points: ["50,000 sq ft Facility", "Defence Drones", "Logistics UAVs", "International Collabs"],
...
const stats = [
  ...
  { target: 50, suffix: "K sqft", label: "Manufacturing", sub: "State-of-the-Art Facility" },
  { target: 100, suffix: "+", label: "Drone Missions", sub: "Completed Projects" },
  { target: 20, suffix: "+", label: "Industry Partners", sub: "Govt · Defence · Enterprise" },
];
...
const projects = [
  { cat: "SURVEY & MAPPING", title: "Highway Corridor Survey", stat: "±2cm accuracy, 65% faster", img: "https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?w=600&h=400&fit=crop" },
  { cat: "SOLAR INSPECTION", title: "200MW Solar Plant Audit", stat: "450+ faults found, ↓80% time", img: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=600&h=400&fit=crop" },
  { cat: "AGRICULTURE", title: "1000-Acre Cotton Farm", stat: "18% yield increase", img: "https://images.unsplash.com/photo-1567359781514-3b964e2b04d6?w=600&h=400&fit=crop" },
];

const directors = [
  { name: "Himanshu Jain", role: "Director", quote: "We are building a complete drone innovation ecosystem — from R&D to manufacturing to defence applications.", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&h=300&fit=crop&face" },
  { name: "Manojkumar Deshpande", role: "Director", quote: "Our 50,000 sq ft facility and active defence UAV R&D positions Soaring Aerotech as a full-cycle drone technology company.", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&face" },
];

const testimonials = [
  { name: "Rahul Verma", role: "DGCA Certified Pilot", text: "Cleared RPC in first attempt. Now flying commercially full-time in MP.", span: "md:col-span-2" },
  { name: "Sneha Patil", role: "Agricultural Drone Operator", text: "Connected my farming background with drone technology.", span: "" },
  { name: "Amit Kumar", role: "Engineering Graduate", text: "Real defence drone hardware access — nowhere else in Central India.", span: "" },
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#111111]">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }} className="text-white/55 text-base md:text-lg mb-6 leading-relaxed max-w-lg">
                From certifying India's next generation of drone pilots to manufacturing defence-grade UAVs — everything under one roof in Madhya Pradesh.
              </motion.p>

              {/* 4 pillars tags */}
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.24 }} className="flex flex-wrap gap-2 mb-8">
                {["🎓 Training", "🛠️ Services", "🔬 R&D", "🏭 Manufacturing"].map((t, i) => (
                  <span key={i} className="px-4 py-1.5 rounded-full border border-white/15 text-white/50 text-sm font-medium">{t}</span>
                ))}
              </motion.div>
            ...
            {/* Hero stats panel */}
            <motion.div initial={{ opacity: 0, x: 32 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35 }} className="hidden lg:grid grid-cols-2 gap-4">
              {[
                { val: "1000+", label: "Pilots Trained", sub: "DGCA Certified", img: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=300&h=200&fit=crop" },
                { val: "50K sqft", label: "Manufacturing", sub: "Production Facility", img: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=300&h=200&fit=crop" },
                { val: "100+", label: "Missions Done", sub: "Completed Projects", img: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=300&h=200&fit=crop" },
                { val: "8+", label: "Programs", sub: "Specialized Courses", img: "https://images.unsplash.com/photo-1534120247760-c44c3e4a62f1?w=300&h=200&fit=crop" },
              ].map((s, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 + i * 0.07 }}
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }} className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 text-white/25 flex flex-col items-center">
      ...
      <section className="py-5 bg-white border-b border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-wrap justify-center gap-3">
            {[
              { icon: <ShieldCheck className="w-3.5 h-3.5 text-primary" />, label: "DGCA Approved RPTO" },
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-border text-xs font-semibold text-foreground/55 tracking-wide">
      ...
      <section className="bg-[#111111]">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-white/8">
            {stats.map((s, i) => (
              <div key={i} className="py-14 px-8 text-center group hover:bg-white/5 transition-colors">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display text-3xl md:text-4xl text-foreground mb-5">50,000 sq ft. Indigenous. Defence-Grade.</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Soaring Aerotech isn't just a training company — we manufacture UAVs. Our facility produces indigenous logistics drones, surveillance UAVs, and custom defence platforms, with active R&D partnerships with DRDO and international collaborators.
              </p>
              ...
              <Link href="/about"><Button className="rounded-full px-8 h-12 font-bold">See Our Facility <ArrowRight className="w-4 h-4 ml-2" /></Button></Link>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=700&h=500&fit=crop" alt="R&D Lab" className="w-full h-80 object-cover rounded-3xl" />
              ...
              <div className="absolute -bottom-4 -right-4 bg-primary text-white rounded-2xl p-5 shadow-xl">
                ...
                <div className="text-sm font-semibold opacity-90">R&D Projects</div>
              </div>
            </div>
            <div>
              <div className="section-label" style={{ color: "rgba(255,255,255,0.3)" }}>INNOVATION LAB</div>
              <h2 className="font-display text-3xl md:text-4xl text-white mb-5">Research That Creates Technology</h2>
              <p className="text-white/50 leading-relaxed mb-6">
                We don't just fly drones — we build the future of drone technology. Our Innovation Lab runs active research in disaster-response UAVs, AI/ML aerial systems, tethered drone platforms, and quantum computing applications for autonomous flight.
              </p>
              <div className="space-y-3 mb-8">
                {[
                  { title: "Disaster Management UAVs", desc: "Rapid deployment systems for flood, fire & search ops" },
                  { title: "AI/ML Autonomous Drones", desc: "Computer vision & edge-AI for autonomous missions" },
                  { title: "Tethered Drone Platforms", desc: "Persistent surveillance with unlimited flight time" },
                  { title: "Defence Payload Engineering", desc: "Custom payloads for military & police applications" },
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-4 p-4 rounded-xl border border-white/8 hover:border-primary/30 hover:bg-white/5 transition-all">
                    <div className="w-2 h-2 rounded-full bg-primary mt-2 shrink-0" />
                    <div>
                      <div className="text-white/80 text-sm font-bold">{item.title}</div>
                      <div className="text-white/35 text-xs mt-0.5">{item.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
              <Link href="/projects"><Button className="rounded-full px-8 h-12 font-bold">Explore Projects <ArrowRight className="w-4 h-4 ml-2" /></Button></Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="font-display text-3xl md:text-4xl text-foreground">Real Missions. Real Impact.</h2>
            </div>
              ...
              >
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="font-display text-lg text-white leading-tight mb-2">{p.title}</h3>
                    <div className="inline-flex items-center gap-1.5 bg-primary/80 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                      {p.stat}
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-8">
            <Link href="/projects"><Button variant="outline" className="rounded-full px-8 h-12 font-bold">View All Case Studies</Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#F5F5F5] border-b border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-3">Partners & Affiliations</h2>
            <p className="text-muted-foreground text-sm max-w-md mx-auto">
              Recognized and supported by India's leading government bodies, defence organisations, and innovation hubs.
            </p>
          </div>
            ...
            {partners.map((p, i) => (
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-xs font-bold text-foreground/70 leading-snug">{p.full}</div>
                  <div className="text-[10px] font-mono text-primary/60 uppercase tracking-widest mt-1">{p.type}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            <div>
              ...
              <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">The Visionaries Behind Soaring</h2>
              <p className="text-muted-foreground text-sm">Built by entrepreneurs who understand drone technology, Indian industry, and the future of autonomous systems.</p>
            </div>
              ...
              {directors.map((d, i) => (
                ...
                >
                  ...
                  <div className="p-5 flex-1">
                    ...
                    <p className="text-sm text-foreground/70 italic leading-relaxed">"{d.quote}"</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="text-foreground font-medium mb-5 leading-relaxed relative z-10">"{t.text}"</p>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/40 text-sm max-w-sm">1000+ certified pilots. 100+ missions. Defence-grade manufacturing. All from Central India.</p>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-6">
            {[
              { icon: <MapPin className="w-4 h-4 text-primary shrink-0" />, text: "Tech Park, Block B, Indore, Madhya Pradesh 452001" },
              { icon: <Phone className="w-4 h-4 text-primary shrink-0" />, text: "+91 78699 18736" },
              { icon: <ShieldCheck className="w-4 h-4 text-primary shrink-0" />, text: "DGCA Approved RPTO · Startup India · MSME Registered · AIC Prestige" },
            ].map((item, i) => (
