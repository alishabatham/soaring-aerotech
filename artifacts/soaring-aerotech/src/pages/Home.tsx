...
const services = [
  {
    ...
    points: ["DGCA Certified RPTO", "8 Specialized Programs", "RPC Certification", "Batch Training Batches"],
  ...
  },
  {
    ...
    desc: "End-to-end aerial solutions for government, enterprise, and defence. Survey, map, inspect, and surveil with precision.",
  ...
  },
  {
    ...
    desc: "Cutting-edge research into disaster UAVs, AI/ML drone systems, and advanced payload engineering for next-gen applications.",
    points: ["Disaster UAVs", "AI/ML Systems", "Payload Engineering", "Defence Tech"],
  ...
  },
  {
    ...
    desc: "50,000 sq ft state-of-the-art facility producing indigenous defence drones, logistics UAVs, and custom platforms.",
    points: ["50,000 sq ft Facility", "Defence Drones", "Logistics UAVs", "Custom Platforms"],
...
const flowSteps = [
  { label: "TRAIN", sub: "DGCA Pilots", icon: <GraduationCap className="w-5 h-5" /> },
  { label: "CERTIFY", sub: "RPC License", icon: <ShieldCheck className="w-5 h-5" /> },
  { label: "SERVE", sub: "B2B Projects", icon: <Target className="w-5 h-5" /> },
  { label: "MANUFACTURE", sub: "Indigenous UAVs", icon: <Factory className="w-5 h-5" /> },
  { label: "DEFEND", sub: "Defence Grade", icon: <Zap className="w-5 h-5" /> },
];

const partners = [
  { name: "DGCA", full: "Directorate General of Civil Aviation", type: "Regulator" },
  { name: "DRDO", full: "Defence Research & Development Organisation", type: "Defence" },
  ...
  { name: "ISRO", full: "Indian Space Research Organisation", type: "Space" },
  { name: "MP Govt.", full: "Madhya Pradesh State Government", type: "State Govt." },
    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#0D1B2A]/80">
        <div className="absolute inset-0">
          <img src="/images/hero-bg.png" alt="" className="w-full h-full object-cover opacity-100 mix-blend-overlay" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0D1B2A] via-[#0D1B2A]/80 to-transparent" />
          <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "linear-gradient(rgba(255,255,255,.4) 1px,transparent 50px),linear-gradient(90deg,rgba(255,255,255,.4) 1px,transparent 1px)", backgroundSize: "60px 60px" }} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <motion.h1
                ...
                className="font-display text-6xl md:text-8xl text-white leading-[0.92] mb-6"
              >
                We Build
                <br />
              ...
              <motion.p
                ...
                className="text-white/55 text-base md:text-lg mb-8 leading-relaxed max-w-lg"
              >
                From pilot training & aerial services to R&D and UAV manufacturing — India's most complete drone ecosystem, based in Central India.
              </motion.p>
            ...
            >
              {[
                { val: "500+", label: "Pilots Trained", sub: "DGCA Certified" },
                { val: "8+", label: "Programs", sub: "Specialized Courses" },
                { val: "100+", label: "Missions", sub: "Completed Projects" },
                { val: "50K sqft", label: "Manufacturing", sub: "Facility Size" },
              ].map((s, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 16 }}
                  ...
                  className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:border-primary/30 transition-colors"
                >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-14">
            ...
            <p className="text-muted-foreground text-base max-w-xl">
              A complete drone ecosystem — from training India's next generation of pilots to building defence-grade UAVs.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((s, i) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-border bg-[#F5F4F0] hover:shadow-xl transition-all duration-500 hover:-translate-y-1"
              >
                {/* Image */}
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="text-xs font-bold font-mono text-primary bg-[#0D1B2A]/70 border border-primary/30 backdrop-blur-sm px-3 py-1.5 rounded-full">
                      {s.tag}
                    </span>
                  </div>
          ...
          <div className="hidden md:flex items-stretch gap-1">
            {flowSteps.map((step, i) => (
              <div key={i} className="flex items-center flex-1 min-w-0">
                ...
                >
                  <div className="flex justify-center mb-3 text-primary/60">{step.icon}</div>
                  <div className="font-display text-xs font-black uppercase tracking-widest text-white/60 mb-1">{step.label}</div>
              ...
              <div key={i}>
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-primary/60">{step.icon}</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {partners.map((p, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.07 }}
                className="group relative flex flex-col items-center justify-center gap-3 p-6 rounded-2xl border border-border bg-[#F5F4F0] hover:border-primary/30 hover:bg-white hover:shadow-md transition-all duration-300 cursor-default"
              >
      ...
      <section className="py-20 bg-[#F5F4F0] border-b border-border">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-foreground mb-8">Industries We Power</h2>
          <div className="flex flex-wrap gap-3">
            {[
              { label: "🏛️ Government", color: "hover:border-blue-400/50" },
              { label: "🛡️ Defence & Police", color: "hover:border-slate-400/50" },
              { label: "🏙️ Smart Cities", color: "hover:border-cyan-400/50" },
              { label: "☀️ Solar Companies", color: "hover:border-yellow-400/50" },
              { label: "🌾 Agriculture", color: "hover:border-green-400/50" },
              { label: "🏗️ Infrastructure", color: "hover:border-orange-400/50" },
              { label: "🔬 Research Labs", color: "hover:border-purple-400/50" },
              { label: "🚀 Startups", color: "hover:border-primary/50" },
            ].map((c, i) => (
              <motion.span
                key={i}
                ...
                className={`px-5 py-2.5 rounded-full bg-white border border-border text-sm font-semibold text-foreground hover:shadow-sm transition-all cursor-default ${c.color}`}
              >
                {c.label}
              </motion.span>
            ))}
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 mb-10">
          <div className="flex items-end justify-between">
            ...
            <Link href="/media" className="text-sm font-semibold text-primary hover:underline hidden md:block">
              View all →
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-sm mb-6">
                Watch our pilots, drone operations, manufacturing floor walkthroughs, and live mission footage.
              </p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1508614589041-895b88991e3e?w=800&h=450&fit=crop" alt="Featured video" className="w-full h-full object-cover opacity-60 group-hover:opacity-70 transition-opacity duration-500" />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/training">
                <Button size="lg" className="h-14 px-8 rounded-full text-base font-bold">Enroll Now</Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="outline" className="h-14 px-8 rounded-full text-base font-semibold border-white/20 text-white hover:bg-white/10">
                  Talk to Expert
          ...
          <div className="mt-14 pt-8 border-t border-white/10 flex flex-wrap gap-6">
            {[
              ...
              { icon: <ShieldCheck className="w-4 h-4 text-primary shrink-0" />, text: "DGCA Approved RPTO · Startup India · MSME Registered" },
            ].map((item, i) => (
